/**
 * p8_2.c - Generating Sawtooth Waveform on LTC1661 using SPI1 (STM32F401RE)
 *
 * This program configures SPI1 as a master and generates a sawtooth waveform
 * by writing to the LTC1661 Digital-to-Analog Converter (DAC).
 *
...
/**
 * Send a 10-bit value to the LTC1661 DAC over SPI1
 */
void DAC_write(uint16_t data)
{
    ...
    /* Prepare command and data bytes */
    upperByte = 0x90 | (data >> 6);  // Upper 4 bits + command
    lowerByte = (data << 2) & 0xFF;  // Lower 8 bits
